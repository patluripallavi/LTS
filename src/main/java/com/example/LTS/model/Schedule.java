...
public class Schedule {
	...
	/*
	 * private Map<String,ArrayList<Scorecard>> scorecard; private
	 * Map<String,ArrayList<Bowling>> ball_by_ball; private
	 * Map<String,ArrayList<Wickets>> wickets;
	 */
	private JSONObject scorecard; private
	JSONObject ball_by_ball; private
	JSONObject wickets;
	
	private Map<String,Extras> extra;
	...
	public Map<String,JSONArray> getScorecard() {
		return scorecard;
	}
	
	public JSONObject getBall_by_ball() {
		return ball_by_ball;
	}
	public void setBall_by_ball(JSONObject ball_by_ball) {
		this.ball_by_ball = ball_by_ball;
	}
	public JSONObject getWickets() {
		return wickets;
	}
	public void setWickets(JSONObject wickets) {
		this.wickets = wickets;
	}
	public void setScorecard(JSONObject scorecard) {
		this.scorecard = scorecard;
	}
	public Map<String, Extras> getExtra() {
		return extra;
	}
	public void setExtra(Map<String, Extras> extra) {
		this.extra = extra;
	}
